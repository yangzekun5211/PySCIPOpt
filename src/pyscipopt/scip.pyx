...
cdef class Variable(Expr):
    ...
    def varsHaveCommonClique(self, value1, Variable var2, value2, regardimplics=True):
        ...
        """
        return SCIPvarsHaveCommonClique(self.var, value1, var2.var, value2, regardimplics);
